...
const paths = {
    ...
    server: {
        ...
        views: [`${serverPath}/**/*.html`, `${serverPath}/**/*.hbs`, `${serverPath}/**/*.css`],
...
gulp.task('start:server:prod', () => {
    ...
    config = require(`./${paths.dist}/${serverPath}/lib/config`);
...
gulp.task('test:server', cb => {
    runSequence('env:all', 'env:test', 'mocha:unit', 'mocha:integration',function() {
        process.exit();
        cb();
    });
});
